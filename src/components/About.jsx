      ...
      <div name="about" className="w-full h-screen bg-gradient-to-b from-rose-400 to-red-500 text-white">
          <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
              ...
              <div>
                  ...
                  I am an aspiring professional with a passion for web development and a drive to continually enhance my skills. Currently majoring in Information Technology, I am dedicated to expanding my knowledge and expertise in the field. Here is a glimpse into my diverse skill set and experiences:
                  </p>
                  <br/>
                  <p className="text-xl">
